class Mf:
    def __init__(self):
        ...
        'lpf.2':{'comm':'Type of layer (confined or convertible)','cond':'','kw':['LAYTYP(NLAY)'],
                 'detail':['Confined (0) or convertible (1)'],'type':['arrint'],'default':[0]},
        ...
        'lpf.11':{'comm':'2nd storage coeff','cond':'NPER>1 and LAYTYP>0','kw':['Sf2(NLAY,NROW,NCOL)'],
        ...
        'uzf.1':{'comm':'General flags','cond':'',
                 ...
                 'detail':[['recharge cell','-','top','spec. layer','upper wet'],['unsat K','no unsat','from VKS','from LPF'],
                           ['budget for gw to surface','removed','routed'],['Evapotranspiration','not simulated','simuated'],
        ...
        'uzf.4':{'comm':'vertical hydr conductivity','cond':'IUZFOPT>0',
        ...
        'uzf.6':{'comm':'max saturation','cond':'IUZFOPT>0',
                 'kw':['THTS(NCOL,NROW)'],'detail':[],'type':['arrfloat'],'default':[0.4]},
        'uzf.7':{'comm':'initial saturation','cond':'IUZFOPT>0',
